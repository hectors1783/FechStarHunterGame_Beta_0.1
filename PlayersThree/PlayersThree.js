...
export default class PlayersThree extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./PlayersThree/costumes/costume1.svg", {
        x: 56.5,
        y: 24.5
      })
    ];

    this.sounds = [new Sound("pop", "./PlayersThree/sounds/pop.wav")];
